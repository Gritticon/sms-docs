---
title: "Deviation: Module not in registry (setup_early_permission_config) — sms-ui"
type: deviation
project: sms-ui
module: setup_early_permission_config
...
- **File:** `sms-ui/lib/views/setup_early_permission_config_view.dart`
- **Violation type:** Module not in official registry
- **Expected pattern:** Feature should map to module/submodule registry doc.
- **Actual:** No registry match detected for feature name.
