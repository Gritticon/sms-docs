---
title: "Deviation: Module not in registry (timetable_template_edit) — sms-ui"
type: deviation
project: sms-ui
module: timetable_template_edit
...
- **File:** `sms-ui/lib/views/timetable_template_edit_view.dart`
