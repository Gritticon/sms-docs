---
title: "Deviation: Feature without repository (engagement) — kyc"
type: deviation
project: kyc
module: engagement
...
- **File:** `kyc/lib/views/engagement`
- **Violation type:** Feature directory without repository/service
- **Expected pattern:** Features should have API integration layer in repositories/services.
- **Actual:** No matching repository/service file detected.
