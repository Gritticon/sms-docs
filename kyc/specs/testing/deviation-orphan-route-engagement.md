---
title: "Deviation: Orphan screen route (engagement) — kyc"
type: deviation
project: kyc
module: engagement
...
- **Violation type:** Route not registered
- **Expected pattern:** Views should be registered in app routing configuration.
- **Actual:** Feature name not detected in router files.
